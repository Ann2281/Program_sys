...
import com.example.demo2.MainApp;
...
public class PersonOverviewController {
        ...
        @FXML
        private Label lesson_typeLabel;
        ...
        private void initialize() {
            ...
            lastNameColumn.setCellValueFactory(cellData -> cellData.getValue().RankProperty());
        ...
        private void showPersonDetails(Person person) {
                if (person != null) {
                        ...
                        DegreeLabel.setText(person.getDegree());
                        postLabel.setText(person.getlesson());
                        lessonLabel.setText(person.getlesson());
                        lesson_typeLabel.setText(person.getlesson_type());
        ...
        private void handleDeletePerson() {
                ...
                if (selectedIndex >= 0) {
                        ...
                        // Ничего не выбрано.
                        Alert alert = new Alert(Alert.AlertType.WARNING);///////? (AlertType.WARNING)
